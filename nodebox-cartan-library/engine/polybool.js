// polybooljs 1.2.2 — https://github.com/velipso/polybooljs (MIT, © 2016 Sean Connelly)
// Vendored browserify build wrapped as an ES module for the no-build setup.
const window = {};
...
export default window.PolyBool;
